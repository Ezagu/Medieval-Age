...
public class GranjaScr : MonoBehaviour
{
    ...
    IEnumerator SumarComida()
    {
        Debug.Log("SUMANDO COMIDA");
        yield return new WaitForSeconds(1f);
        recursosScr.comida += comidaPorAldeano * transform.childCount;
        StartCoroutine("SumarComida");
